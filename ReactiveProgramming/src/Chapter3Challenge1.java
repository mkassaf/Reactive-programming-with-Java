...
public class Chapter3Challenge1 {
    ...
    public static void main(String[] args) {
        ...
        List<String> peopleNames = people.stream().map(peopleObject -> peopleObject.name).collect(Collectors.toList());
        ...
        System.out.println("BlueCars " + BlueCars.size());
        ...
        Float sum = employees.stream().map(employee -> employee.salary).reduce(0f, (acc, x) -> acc + x);
